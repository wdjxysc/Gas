...
import sockets.iotmeter.frame.Responder;
...
class Handler implements Runnable{
	...
	public void messageHandler(byte[] message){
		...
		Responder responder = new Responder(messageStr,socket.getInetAddress().getHostAddress(),socket.getPort());
