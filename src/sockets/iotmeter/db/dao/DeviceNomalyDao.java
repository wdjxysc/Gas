 ...
 *
 */
public class DeviceNomalyDao {
	private static Logger log = Logger.getLogger(DeviceNomalyDao.class);
	 ...
	 * @throws Exception
	 */
	public int saveDeviceNomaly(DeviceNomalyVo vo) throws Exception{
		log.info("DeviceNomalyDao saveDeviceNomaly(DeviceNomalyVo vo) 方法开始处理...");
