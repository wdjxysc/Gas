...
import sockets.iotmeter.db.dao.AirIndexDao;
import sockets.iotmeter.db.dao.DeviceDao;
import sockets.iotmeter.db.dao.DeviceNomalyDao;
import sockets.iotmeter.db.dao.MeterDataDao;
import sockets.iotmeter.db.vo.AirIndexVo;
import sockets.iotmeter.db.vo.DeviceNomalyVo;
import sockets.iotmeter.db.vo.DeviceVo;
import sockets.iotmeter.db.vo.MeterDataVo;
import sockets.iotmeter.encode.RTHCDecoder;
...
public class ResponderIotMeter implements Serializable {
    ...
    private void opDeviceNomaly(String dataStr,String devNo){
        DeviceNomalyVo vo = new DeviceNomalyVo();
        DeviceNomalyDao dao = new DeviceNomalyDao();
