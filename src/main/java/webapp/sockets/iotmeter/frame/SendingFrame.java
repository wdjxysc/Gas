...
public class SendingFrame implements Serializable{
     ...
     * @param endByte
     */
    public SendingFrame(byte[] beginByte, LengthClass lc, CtrlCode cc, DirectionResponseFlag drf, ClientID clientId, MessageID messageID, LengthClass df_lc, ResponseFlag rf,
    ...
    public byte[] organizeField() {
        ...
        try {
            ...
            pos += 2;
            System.arraycopy(clientId.getSubStationIdByte(), 0, result, pos, 7);
            pos += 7;
            System.arraycopy(messageID.getMessageID(), 0, result, pos, 7);
            pos += 7;
